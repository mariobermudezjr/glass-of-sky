...
const HomePage = () => {
  ...
  // console.log('INDEX GlobalState: ', globalState)
  // console.log('INDEX globalDispatch: ', globalDispatch)

  return (
    <div>
      Signin:
      <form onSubmit={handleSubmit}>
        <input value={current.context.username} onChange={handleUsernameChange} />
        <input value={current.context.password} onChange={handlePasswordChange} />
